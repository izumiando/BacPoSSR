...
To view the sample datasets available in this package, run the following line in your R console.
...
pathFeatureMatrix <- system.file("extdata", "sampleFeatureMatrix.csv", package = "BacPoSSR")
pathPhenotypeData <- system.file("extdata", "samplePhenotypeData.csv", package = "BacPoSSR")
pathGroupAssignments <- system.file("extdata", "sampleGroupAssignments.csv", package = "BacPoSSR")
...
# format the data objects so that the column with sample names are assigned as row names
row.names(sampleFeatureMatrix) <- sampleFeatureMatrix[, 1] # assigning first column as row names 
sampleFeatureMatrix <- sampleFeatureMatrix[, -1] # removing redundant first column
