...
```
`BacPoSSR` contains 3 functions. BacPoSSR can be contextualized in the GWAS / ML predictive studies pipeline as illustrated in the image below.
...
The _plotMultCompAnalysis_ function formats the input data (feature matrix and group assignments) and utilizes the _MCA_ function from the `FactoMineR` package to conduct Multiple Component Analysis and the _fviz_mca_ind_ function from the `factoextra` package to plot the results. 
